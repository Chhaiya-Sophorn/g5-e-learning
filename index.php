...
if (urlIs("/admin") || urlIs('/courses_as_admin') || urlIs('/courseEdit') || urlIs('/createCourse') || urlIs('/categories') || urlIs('/viewCourse') || urlIs('/updateCourse')|| urlIs("/admin") || urlIs('/addCourse')) { 
