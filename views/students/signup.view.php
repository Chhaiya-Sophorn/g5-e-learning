                ...
                <div class="rounded p-2 p-sm-5 my-4 mx-3 shadhow-lgbd" style="background-color: rgba(0, 0, 0,0.4);">
                    ...
                    <form action="/create_student" method="post" class='bd bd-info' enctype="multipart/form-data">                          
                        <div class="form-floating mb-2 border-info rounded">
                            ...
                            <input type="name" class="form-control bd-primary form-control-lg text-info" id="floatingInput" placeholder="Name" style="background-color: rgba(0,0,0,0.3); <?php if($input==true){if(strlen($require['name'])>0){echo 'border: 1px solid lightcoral;'; }}?>" name='name' value='<?php if($input==true){echo $_POST['name'];} ?>'>
                        ...
                        <div class="form-floating mb-2 border-info rounded">
                            ...
                            <input type="text" class="form-control form-control-lg text-info" id="floatingInput" placeholder="Phone" style="background-color: rgba(0, 0, 0, 0.3);<?php if($input){ if(strlen($require['phone'])>0){echo 'border: 1px solid lightcoral;';}}?>" name='phone' value="<?php if($input){echo $_POST['phone'];} ?>">
                        ...
                        <div class="form-floating mb-2 border-info rounded">
                            ...
                            <input type="email" class="form-control form-control-lg text-info" id="floatingInput" placeholder="name@example.com" style="background-color: rgba(0, 0, 0, 0.3);<?php if($input){if(strlen($require['email'])>0){echo 'border: 1px solid lightcoral;';}}?>" name='email' value=' <?php if($input){echo $_POST['email'];} ?>'>
                        ...
                        <div class="form-floating mb-2 border-info rounded">
                            ...
                            <input type="password" class="form-control form-control-lg text-info" id="floatingPassword" placeholder="Password" style="background-color: rgba(0, 0, 0, 0.3);<?php if($input){if(strlen($require['password'])>0){echo 'border: 1px solid lightcoral;';}}?>" name='password' value='<?php if($input){echo $_POST['password'];} ?>'> 
                        ...
                        <div class="form-floating mb-2 border-info rounded">
                            ...
                            <input type="password" class="form-control form-control-lg text-info" id="floatingPassword" placeholder="password_comfirm" style="background-color: rgba(0, 0, 0, 0.3);<?php if($input){if(strlen($require['password_comfirm'])>0){echo 'border: 1px solid lightcoral;';}}?>" name='password_comfirm' value='<?php if($input){echo $_POST['password_comfirm'];} ?>'> 
