    ...
    <!-- <div class="container-fluid">
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-lg-4">
                <div class="rounded p-4 p-sm-5 my-4 mx-3 bg-white shadhow-lg" style="background-color: rgba(0, 0, 0, 0.3);">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h3 class="text-dark" >Sign In</h3>
                    </div>
                
                    <form action="controllers/trainer/trainerLoginProcess.controller.php" method="post" class="needs-validation" novalidate>

                        <div class="form-floating mb-3 " >
                            <input type="email" name="email" class="form-control bg-white shadow " id="floatingInput" placeholder="name@example.com" style="background-color: rgba(0, 0, 0, 0.5);" name='email'>
                            <label for="floatingInput" class="text-dark" >Email address</label>
                        </div>
                        <div class="form-floating mb-3 " >
                            <input type="password" name="password" class="form-control bg-white shadow" id="floatingInput" placeholder="password" style="background-color: rgba(0, 0, 0, 0.5);" name='password'>
        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-lg-4">
                <div class="rounded p-4 p-sm-5 my-4 mx-3 shadhow-lg" style="background-color: rgba(0, 0, 0, 0.3);">
                    ...
                    <form action="/trainerAccess" method='post'>
                        <div class="form-floating mb-3 " >
